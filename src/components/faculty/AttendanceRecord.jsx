...
const AttendanceRecord = () => {
    ...
    // Fetch Departments, Batches, and Subjects
    useEffect(() => {
    ...
    useEffect(()=>{
        const students= async()=>{
            try {
                ...
                console.log("studnn", response.data);
    ...
    {loading ? (
        ...
        attendanceRecords.map((record, index) => (
            <tr key={record.id}>
                ...
                {/* Get Department Name */}
                <td>{departments.find(dept => dept.id === record.department)?.department_name || "N/A"}</td>

                {/* Get Batch Name */}
                <td>{batches.find(batch => batch.id === record.batch)?.batch_name || "N/A"}</td> 

                {/* Get Subject Name */}
                <td>{subjects.find(subject => subject.id === record.subject)?.name || "N/A"}</td>
